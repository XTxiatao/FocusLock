...
public final class ItemWhitelistAppBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemWhitelistAppBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemWhitelistAppBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_whitelist_app, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemWhitelistAppBinding bind(@NonNull View rootView) {
