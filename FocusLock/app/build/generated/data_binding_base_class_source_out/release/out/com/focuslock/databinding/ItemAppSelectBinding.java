...
public final class ItemAppSelectBinding implements ViewBinding {
  ...
  private ItemAppSelectBinding(@NonNull LinearLayout rootView, @NonNull CheckBox appCheckBox,
  ...
  public static ItemAppSelectBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAppSelectBinding((LinearLayout) rootView, appCheckBox, appIcon, appLabel);
    }
